...
class UserRankingServiceTest {
        ...
        void testProfileCompletionMilestone_50Percent_ShouldAdd3Points() {
                ...
                // Assert: Deve ter 10 (inicial) + 3 (milestone 50%) + 15 (phone milestones: 5
                // first + 10 for 3+) = 28 pontos
                assertEquals(28, updated.getTotalScore(),
                                "Score should be 10 (initial) + 3 (50% milestone) + 15 (phone milestones) = 28");
        ...
        void testProfileCompletionMilestone_100Percent_ShouldAdd10Points() {
                ...
                // Assert: Deve ter 20 (inicial) + 10 (milestone 100%) + 21 (phone milestones: 5
                // first + 3 WhatsApp + 3 Telegram + 10 for 5 phones) = 51 pontos
                assertEquals(51, updated.getTotalScore(),
                                "Score should be 20 (initial) + 10 (100% milestone) + 21 (phone milestones) = 51");
        ...
        void testProfileCompletionMilestone_MultipleUpdatesWithPhoneFields_ShouldPersistAllFields() {
                ...
                // Score = 5 (initial) + 3 (50% milestone) + 21 (phone milestones: 5 first + 3
                // WhatsApp + 3 Telegram + 10 for 5 phones) = 29
                assertEquals(29, updated.getTotalScore(), "Score should be 5 + 3 + 21 (phone milestones) = 29");
                assertEquals(50, updated.getProfileCompletionPercentage());
