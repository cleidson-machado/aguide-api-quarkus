...
/**
 * DTO para criação de nova escolha de perfil de usuário.
 * Utilizado no endpoint POST /api/v1/user-choices.
 *
 ...
 * - Enums validados via Custom Validators
 * (@ValidContentFormats, @ValidInfoSources)
 */
public class CreateUserChoiceRequest {
    ...
    // Construtores
    public CreateUserChoiceRequest() {
    }
